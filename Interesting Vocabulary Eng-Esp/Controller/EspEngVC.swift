...
class SpainEnglishVC: UIViewController, UISearchBarDelegate, UISearchControllerDelegate {
...
extension SpainEnglishVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func startSearch(text: String) {
        if (text.isEmpty) {
            ...
            filterWords = []
            for i in data {
                if i.spanish.contains(text.lowercased()) {
